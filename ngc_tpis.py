...
settings['n_days_window_reference'] = 360
...
import pickle
#outputs_all = Parallel(n_jobs=2, prefer='processes')(delayed(get_changes_for_tpi)(tpi, config_db) for tpi in tqdm(tpis_optical))
#outputs = []
counter = 150
for tpi in tqdm(tpis_optical[150:]):
